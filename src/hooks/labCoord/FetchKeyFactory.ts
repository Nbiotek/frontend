...
export const labCoord = {
  getDashboard() {
    return {
      ...
      keys: () => [QUERY_KEY.LAB_DASHBOARD, LAB_COORD.DASHBOARD] as const
    };
  },
  ...
  getAllTests(query: Partial<TTestQuery>) {
    return {
      ...
      keys: () => [QUERY_KEY.LAB_DASHBOARD, LAB_COORD.DASHBOARD, TEST.GET_REQUESTS, query] as const,
      params: query
    };
  },
  ...
  getAvailableLabTechs() {
    return {
      ...
      keys: () =>
        [QUERY_KEY.LAB_DASHBOARD, LAB_COORD.DASHBOARD, LAB_COORD.AVAILABLE_TECHNICIAN] as const
    };
  },
  ...
  getAvailableMarketers() {
    return {
      ...
      keys: () =>
        [QUERY_KEY.LAB_DASHBOARD, LAB_COORD.DASHBOARD, LAB_COORD.AVAILABLE_MARKETERS] as const
    };
  },
  ...
  getAvailableDoctors() {
    return {
      ...
      keys: () =>
        [QUERY_KEY.LAB_DASHBOARD, LAB_COORD.DASHBOARD, LAB_COORD.AVAILABLE_DOCTORS] as const
    };
  },
  ...
  getLabInventory(query: Partial<TinventoryQuery>) {
    return {
      ...
      keys: () =>
        [QUERY_KEY.LAB_DASHBOARD, LAB_COORD.DASHBOARD, LAB_COORD.INVENTORY, query] as const,
      params: query
    };
  },
