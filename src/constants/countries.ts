...
export const allCountries = [
  ...
  { name: 'Germany', abbr: 'DE', code: '49' },
  {
    ...
    abbr: 'GH',
    code: '233',
    groupBy: [CountryGroup.ACTIVE, CountryGroup.AFRICA]
  },
  ...
  { name: 'Somalia', abbr: 'SO', code: '252' },
  {
    ...
    abbr: 'ZA',
    code: '27',
    groupBy: [CountryGroup.AFRICA, CountryGroup.ACTIVE]
  },
  {
...
export const getCountryMeta = (country: string) => {
  if (!country) return { name: '', code: '', cca2: '', cca3: '' };
  const _country = country.toLowerCase();

  if (_country === 'nigeria') return { name: 'Nigeria', code: 'NG', cca2: 'NG', cca3: 'NGA' };
  if (_country === 'ghana') return { name: 'Ghana', code: 'GH', cca2: 'GH', cca3: 'GHA' };
  if (_country === 'kenya') return { name: 'Kenya', code: 'KE', cca2: 'KE', cca3: 'KEN' };
  if (_country === 'south africa')
    return { name: 'South Africa', code: 'ZA', cca2: 'ZA', cca3: 'ZAF' };
  if (_country === 'united states')
    return { name: 'United States', code: 'US', cca2: 'US', cca3: 'USA' };
  if (_country === 'united kingdom')
    return { name: 'United Kingdom', code: 'GB', cca2: 'GB', cca3: 'GBR' };
  return { name: '', code: '', cca2: '', cca3: '' };
};
