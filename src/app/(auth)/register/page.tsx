    ...
    <>
      <Card className="w-full bg-transparent border-none shadow-none ">
        <CardHeader className="text-center">
          <CardTitle className="text-neutral-700 text-[24px] font-normal">Create Account</CardTitle>
          <CardDescription className="text-neutral-700 text-[20px] font-light"> Please fill in the details below</CardDescription>
        </CardHeader>
        ...
        <CardFooter className=" w-full ">
          <Text variant="small" color="warning_cr" weight="light" align="center" className="w-full mt-5 text-gray_light"> Don’t want to sign in yet? <span className="text-blue-300">Explore</span></Text>
        </CardFooter>
      </Card>
      <div className="w-[330px]">
        <Text align="center" variant="body" weight="light" className="text-gray_light"> By creating an account you argree to  <span className="font-bold text-neutral-1000">NBIOTEK</span> <Link href='' className="font-[500] text-blue-300 underline">Terms</Link> and <Link href='' className="font-[500] text-blue-300 underline">Condition</Link></Text>
      </div>
    </>
