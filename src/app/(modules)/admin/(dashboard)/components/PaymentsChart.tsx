...
import { useFetchPaymentChart } from '@/hooks/admin/useFetchPaymentChart';
...
const PaymentChart = () => {
  ...
  const { data, isLoading } = useFetchPaymentChart({ period: timeRange });
    ...
    <Card>
      <CardHeader>
        <div className="grid flex-1 gap-1 text-center sm:text-left">
          ...
          <CardDescription>Graph of all payments.</CardDescription>
        </div>
